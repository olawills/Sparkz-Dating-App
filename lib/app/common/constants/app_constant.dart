...
String loginText = 'Login into your account';
String signupText = 'Create an account';
String interestText =
    'Select 3 niches to help personalize your friends suggestion';
String otpText(String email) => 'Enter 4 digit code sent to $email';
const forgotPasswordText =
    'Enter your email and we will send a otp code to you';
